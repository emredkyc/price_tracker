<div align="center">
  <br />
    <a href=" https://price-tracker-dev.vercel.app" target="_blank">
      <img src="https://i.ibb.co/Gxmw0KG/scrapping.png" alt="Project Banner">
    </a>
  <br />
...
```bash
git clone https://github.com/emredkyc/price_tracker.git
cd price_tracker
```
...
Assets used in the project are [here](https://drive.google.com/file/d/1wcV5Jg42CYsF3UMQh771a8eZn1b702iy/view)
